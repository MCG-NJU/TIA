...
class pascal_voc(imdb):
    def __init__(self, image_set, year, devkit_path=None):
        ...
        # self._data_path = os.path.join(self._devkit_path, "VOCdevkit", "VOC" + self._year)
        self._data_path = os.path.join(self._devkit_path, self._year, 'trainval')
        self._classes = (
    ...
    def _get_default_path(self):
        ...
        return os.path.join("data", "pascal_voc")
    ...
    def _do_matlab_eval(self, output_dir="output"):
        ...
        cmd += "voc_eval('{:s}','{:s}','{:s}','{:s}'); quit;\"".format(
            self._data_path, self._get_comp_id(), self._image_set, output_dir
        )
        print("Running:\n{}".format(cmd))
